...
class Team():
    ...
    division_win_percentage: float = field(default=0.0)
    conference_wins: int = field(default=0)
    conference_losses: int = field(default=0)
    conference_ties: int = field(default=0)
    conference_win_percentage: float = field(default=0.0)
    strength_of_victory: float = field(default=0.0)
    strength_of_schedule: float = field(default=0.0)
    points_for_in_conference_games: int = field(default=0)
    points_against_in_conference_games: int = field(default=0)
    offensive_rank: int = field(default=0)
    defensive_rank: int = field(default=0)
    offensive_rank_in_conference: int = field(default=0)
    defensive_rank_in_conference: int = field(default=0)
    combined_score_ranking: int = field(default=0)
    combined_score_ranking_in_conference: int = field(default=0)
